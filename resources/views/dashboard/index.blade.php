...
@php
    ...
    $businessTargets = [
        ['label' => 'Appliances', 'value' => 189, 'color' => '#ED701D'],
        ['label' => 'Automotive', 'value' => 136, 'color' => '#E8B430'],
        ['label' => 'Computers', 'value' => 401, 'color' => '#45A182'],
        ['label' => 'Electronics', 'value' => 515, 'color' => '#A63057'],
    ];
                ...
                <svg class="business-pie-svg" viewBox="0 0 252 166" role="img" aria-label="Exploded 3D business targets pie chart">
                    <defs>
                        ...
                        <filter id="pieShadow" x="-20%" y="-20%" width="140%" height="150%">
                            <feDropShadow dx="0" dy="12" stdDeviation="7" flood-color="#3D1C02" flood-opacity="0.22" />
                        </filter>
                    </defs>
